import myImage from "@/assets/images/my pic.png";
import Image from "next/image";
import ArrowDown from "@/assets/icons/arrow-down.svg";
import grainImage from "@/assets/images/grain.jpg";
import StarIcon from "@/assets/icons/star.svg";
import Download from "@/assets/icons/download-svgrepo-com.svg";
    ...
    <div className="py-32 md:py-48 lg:py-60 relative z-0 overflow-x-clip ">
      ...
      <div className="container">
        <div className="flex flex-col items-center">
          <Image src={myImage} className="size-[100px]" alt="my Image" />
        ...
        <div className="max-w-lg mx-auto">
          ...
          <p className=" mt-4 text-center text-white/60 md:text-lg">
            A passionate fullstack developer from India and Graduated in
            Computer Science and Engineering at Visvesvaraya Technological
            University
          </p>
        </div>
